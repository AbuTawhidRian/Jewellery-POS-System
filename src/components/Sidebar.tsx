...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-64 bg-white dark:bg-[#0B0F19] transition-colors duration-300 h-screen flex flex-col hidden md:flex shrink-0">
              ...
              className={({ isActive }) =>
                clsx(
                  ...
                  isActive 
                    ...
                    : 'text-slate-600 dark:text-[#94A3B8] font-medium border-l-2 border-transparent hover:bg-slate-50 dark:hover:bg-[#151B23] hover:text-slate-900 dark:hover:text-white'
                )
              }
            >
      ...
      <div className="p-4 mt-auto">
        <div className="px-4 py-3 bg-slate-50 dark:bg-[#151B23] rounded-xl border border-slate-200 dark:border-[#334155]/50 flex items-center gap-3 shadow-lg transition-colors duration-300">
          <div className="relative flex h-3 w-3">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-3 w-3 bg-emerald-500"></span>
          </div>
          <div>
            <p className="text-[10px] text-slate-500 dark:text-[#94A3B8] uppercase tracking-wider font-bold">System Status</p>
