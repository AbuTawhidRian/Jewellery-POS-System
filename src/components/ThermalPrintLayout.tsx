    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <div className="flex flex-col items-center w-full px-1 mt-1 text-[9px] font-semibold">
          ...
          <div className="flex justify-between w-full leading-tight">
            <span className="text-[8px] text-slate-700">{printItem.type}</span>
            {parseFloat(printItem.stone_weight as any || '0') > 0 ? (
              <span className="text-[8px]">NW: {(parseFloat(printItem.weight as any || '0') - parseFloat(printItem.stone_weight as any || '0')).toFixed(2)}g</span>
            ) : (
              <span></span>
            )}
          </div>
