  ...
  return (
    <div className="flex h-screen bg-white dark:bg-slate-950 transition-colors duration-300 overflow-hidden font-sans animate-page-in">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white dark:bg-slate-950 transition-colors duration-300">
        <TopNav />
        <main className="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-900 transition-colors duration-300 shadow-inner md:rounded-tl-[2.5rem] md:border-t md:border-l border-slate-200 dark:border-slate-800 relative print:hidden pb-20 md:pb-0">
          <div className="w-full h-full max-w-[1600px] mx-auto p-4 md:p-6 lg:p-8 flex flex-col">
            <Outlet />
          </div>
        </main>
      </div>
